...
//                        }
    ...
    function openPowitalnyContentReady() {
        ...
        var circleTween = createjs.Tween.get(circle).to({ x: 900}, 1000, createjs.Ease.getPowInOut(4) );
        ...
        var obrazekTween = createjs.Tween.get(obrazek).to({ alpha: 0 , scale:0.1 }, 0 ).wait(600).to({alpha:1, scale:0.4}, 300).wait(4600).to({alpha:0, scale: 0.1}, 300);
        ...
        var textTween = createjs.Tween.get(text).to({ alpha: 0 }, 0, createjs.Ease.elasticOut() ).wait(600).to({alpha:1}, 300).wait(4600).to({alpha:0 }, 300, createjs.Ease.elasticIn() );
